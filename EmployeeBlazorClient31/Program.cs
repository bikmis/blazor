...
namespace EmployeeBlazorClient31
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddSingleton(sp => new HttpClient { BaseAddress = new Uri(builder.HostEnvironment.BaseAddress) }); //This HttpClient is for Weather Forcast (/fetchdata)
